    ...
    <>
      <section className="relative border-b-2 border-mocha bg-kraft-light">
        <div className="relative mx-auto max-w-7xl px-5 py-16 lg:px-10">
          ...
          <h1 className="mt-6 font-display text-5xl leading-[0.9] sm:text-6xl md:text-7xl lg:text-8xl">
            COMUNQUE LA GENTE<br />
            <span className="text-grape">NON STA BENE.</span>
          </h1>
          <p className="mt-6 font-hand text-3xl text-grape">noi siamo in ferie... scherziamo.</p>
        </div>
      </section>
      ...
      <section className="border-b-2 border-mocha bg-kraft">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 lg:grid-cols-[1fr_1.1fr] lg:gap-16 lg:px-10">
          <div className="relative">
            <img
              src={posterSecret}
              alt="Poster Global Street Local Soul"
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 space-y-5 text-base leading-relaxed text-mocha">
              <p className="font-hand text-2xl text-mocha">
                Di chiamare le cose con il loro nome convenzionale.
              </p>
              <p>
                Buatt nasce nel 2014 a Eboli da un'idea semplice: aprire uno spazio dove
                la cucina di strada incontra la ricerca, dove la birra artigianale convive
                con l'Aglianico, dove la musica live non è un'aggiunta ma parte della pietanza.
              </p>
              <p>
                Abbiamo iniziato a chiamarle per quello che sono veramente.
                <strong className="text-brick"> Global. Street. Local. Soul.</strong>
              </p>
              <p>
                "L'essenza non ha bisogno di filtri" non è uno slogan: è il modo in cui
                scegliamo gli ingredienti, accogliamo gli ospiti, costruiamo le serate.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="border-b-2 border-mocha bg-kraft">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 lg:grid-cols-2 lg:gap-16 lg:px-10">
          <div className="flex flex-col justify-center order-2 lg:order-1">
            ...
            <h2 className="mt-3 font-display text-4xl leading-none sm:text-5xl md:text-6xl">
              LA CAMPANIA<br />
              <span className="text-teal">NEL PIATTO.</span>
            </h2>
            <p className="mt-6 font-hand text-2xl text-mocha">
              Carne italiana, pane fatto in casa, vini autoctoni, cocktail firmati.
            </p>
            <ul className="mt-8 grid grid-cols-2 gap-3">
              {["Bufala campana", "Pane lievitato 24h", "Aglianico del Vulture", "Carne italiana", "Birre artigianali", "Erbe spontanee"].map((t, i) => (
                <li key={t} className="flex items-center gap-3 border-2 border-mocha bg-kraft-light px-3 py-2 font-mono text-xs uppercase tracking-widest" style={{ transform: `rotate(${i % 2 === 0 ? -1 : 1}deg)` }}>
